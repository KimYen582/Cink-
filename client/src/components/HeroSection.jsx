    ...
    return (
        <div
         ...
         style={{ backgroundImage: `url(${assets.hero})` }}>
            ...
            <p className='max-w-md text-gray-300'>CineK là điểm đến dành cho những người yêu điện ảnh nơi mang đến trải nghiệm xem phim hiện đại thoải mái và đầy cảm xúc. CineK xem nhiều hơn, cảm nhận sâu hơn.</p>
