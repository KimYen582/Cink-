...
import { PlayCircleIcon, TicketIcon } from 'lucide-react'
    ...
    return (
        <div className='relative h-[100svh] w-full overflow-hidden flex items-center'>
            ...
            <div className='relative z-10 flex flex-col items-start justify-center gap-6 px-6 md:px-16 lg:px-32 w-full max-w-7xl mx-auto pt-20'>
                ...
                <h1 className='text-2xl sm:text-4xl md:text-7xl lg:text-[80px] leading-[1.1] font-black max-w-none whitespace-nowrap text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-200 to-gray-500 animate-fade-in-up drop-shadow-[0_0_30px_rgba(255,255,255,0.1)]' style={{ animationDelay: '350ms' }}>
                ...
                <div className='flex items-center gap-4 md:gap-6 text-sm md:text-base font-medium text-gray-300 flex-wrap animate-fade-in-up' style={{ animationDelay: '500ms' }}>
                    <span className='text-primary-light font-bold uppercase tracking-wider'>Chạm vào từng khoảnh khắc</span>
